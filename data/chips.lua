...
return {
    ...
    -- Used by Chips.breakdown to pick the primary denomination — the goal
    -- isn't fewest-chips, it's a pile whose chip count signals magnitude
    -- at a glance. Tiny wins look like 3-4 chips; jackpots look like a
    -- pile of 30+. See views/Chips.lua:breakdown.
    tier_chip_target = {
        tiny    = 4,
        small   = 10,
        medium  = 20,
