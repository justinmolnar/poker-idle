> **Legacy (moved 2026-08-25). Obsolete premise.** The whole arc here starts from Run 0 (forced bust, free Poker Poster). Run 0 was cut in July 2026; the demo is Act 1 up to the first clear, starting in a working state. Item names and per-item shove values are from the old catalog (items are flat 1% each now, 52 of them, 16 renamed in August).
