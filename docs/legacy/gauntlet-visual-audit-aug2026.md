> **Legacy (moved 2026-08-25).** Written 08-23 as "nothing built"; most of section 5 was built on 08-24 (see `docs/shove-sequence-design.md`) and the gauntlet changed again after (room intro, ITEMS/BANK readout, number flights, the ending). Every `file:line` reference is dead.
