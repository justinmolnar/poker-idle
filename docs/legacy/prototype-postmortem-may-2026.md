> **Legacy (moved 2026-08-25). Historical record.** The May 2026 prototype post-mortem. Its conclusions drove the June readability pass and the July tutorial redesign; the specifics (PP, run 0, the how-to-play modal) are all since replaced.
