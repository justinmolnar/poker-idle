> **Legacy (moved 2026-08-25). Historical record.** Accurate about May 2026 (the public prototype's first two weeks). Nothing here describes the current build: PP became {chip}, Run 0 is gone, the tutorial is the House.
