> **Legacy (moved 2026-08-25).** Design doc v1, superseded by `docs/designv2.md` in May 2026 (itself dated; see its banner). Two elevator pitches and two reference lists existed side by side; this is the older one.
