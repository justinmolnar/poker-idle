> **Legacy (moved 2026-08-25).** Already superseded 2026-08-24 by the two-tier story-beat / popup delivery in `docs/house-script.md`. Kept for the original teaching intent and trigger ideas.
